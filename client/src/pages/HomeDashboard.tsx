  ...
  return (
    <div className="min-h-screen bg-background w-full overflow-y-auto relative selection:bg-accent/30 selection:text-white">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-warning/10 rounded-full blur-[120px] mix-blend-screen animate-blob animation-delay-2000"></div>
        <div className="absolute top-[40%] left-[50%] w-[30%] h-[30%] bg-danger/5 rounded-full blur-[100px] mix-blend-screen animate-blob animation-delay-4000"></div>
      ...
      <div className="space-y-12 max-w-7xl mx-auto pt-16 pb-20 px-6 relative z-10">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-br from-accent/5 via-transparent to-warning/5"></div>
          ...
          <div className="relative z-10 p-12 md:p-20 flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            >
              Intelligence for <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent via-accentHover to-warning animate-gradient-x">
            ...
            >
              <Link href="/graph" className="block">
                <button className="relative group overflow-hidden bg-accent text-gray-950 px-8 py-4 rounded-xl font-bold flex items-center justify-center shadow-[0_0_20px_rgba(0,200,83,0.3)] transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(0,200,83,0.5)]">
        ...
        >
          <motion.div variants={item} className="group relative glass-card p-8 rounded-3xl border border-gray-800/60 hover:border-accent/40 transition-all duration-500 overflow-hidden bg-gradient-to-b from-gray-900/50 to-gray-950/50">
            ...
            <div className="mt-6 h-1 w-full bg-gray-800 rounded-full overflow-hidden">
              <div className="h-full bg-accent w-[85%] rounded-full shadow-[0_0_10px_rgba(0,200,83,0.8)]"></div>
            </div>
          </motion.div>
          
          <motion.div variants={item} className="group relative glass-card p-8 rounded-3xl border border-gray-800/60 hover:border-danger/40 transition-all duration-500 overflow-hidden bg-gradient-to-b from-gray-900/50 to-gray-950/50">
            <div className="absolute top-0 right-0 w-32 h-32 bg-danger/5 rounded-full blur-2xl group-hover:bg-danger/10 transition-all duration-500"></div>
            <div className="relative z-10 flex items-start justify-between">
              <div>
                ...
                <div className="flex items-baseline space-x-2">
                  ...
                  <span className="text-danger text-sm font-bold">Critical</span>
                </div>
              </div>
              <div className="p-4 bg-gray-900 border border-gray-800 rounded-2xl text-danger shadow-inner group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">
                <ShieldAlert className="w-7 h-7" />
              </div>
            </div>
            <div className="mt-6 h-1 w-full bg-gray-800 rounded-full overflow-hidden">
              <div className="h-full bg-danger w-[15%] rounded-full shadow-[0_0_10px_rgba(211,47,47,0.8)]"></div>
            </div>
          </motion.div>

          <motion.div variants={item} className="group relative glass-card p-8 rounded-3xl border border-gray-800/60 hover:border-info/40 transition-all duration-500 overflow-hidden bg-gradient-to-b from-gray-900/50 to-gray-950/50">
            <div className="absolute top-0 right-0 w-32 h-32 bg-info/5 rounded-full blur-2xl group-hover:bg-info/10 transition-all duration-500"></div>
            <div className="relative z-10 flex items-start justify-between">
              <div>
                ...
                <div className="flex items-baseline space-x-2">
                  ...
                  <span className="text-info text-sm font-bold">Vectors</span>
                </div>
              </div>
              <div className="p-4 bg-gray-900 border border-gray-800 rounded-2xl text-info shadow-inner group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-500">
                <FileText className="w-7 h-7" />
              </div>
            </div>
            <div className="mt-6 h-1 w-full bg-gray-800 rounded-full overflow-hidden">
              <div className="h-full bg-info w-[60%] rounded-full shadow-[0_0_10px_rgba(59,130,246,0.8)]"></div>
            </div>
          </motion.div>
        </motion.div>
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Link href="/documents" className="block group">
              <div className="relative h-full bg-gray-900/40 backdrop-blur-md p-8 rounded-3xl border border-gray-800 hover:border-warning/50 transition-all duration-500 overflow-hidden">
                ...
                <div className="absolute -right-10 -bottom-10 opacity-5 group-hover:opacity-10 transition-all duration-700 transform group-hover:scale-125 group-hover:rotate-12">
                  <FileText className="w-64 h-64 text-warning" />
                </div>
                
                <div className="relative z-10 flex flex-col h-full">
                  <div className="w-16 h-16 rounded-2xl bg-gray-900 border border-gray-700 flex items-center justify-center mb-6 group-hover:border-warning/50 transition-colors shadow-lg">
                  ...
                  <div className="flex items-center text-warning font-bold text-sm tracking-widest uppercase">
            ...
            <Link href="/graph" className="block group md:col-span-2">
              <div className="relative h-full bg-gradient-to-br from-info/20 to-gray-900/40 backdrop-blur-md p-8 md:p-12 rounded-3xl border border-gray-800 hover:border-info/50 transition-all duration-500 overflow-hidden">
                ...
                <div className="absolute right-0 top-1/2 -translate-y-1/2 opacity-[0.03] group-hover:opacity-10 transition-all duration-1000 transform group-hover:scale-110 group-hover:-rotate-12">
                  <Network className="w-[400px] h-[400px] text-info" />
                </div>
                
                <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between h-full">
                  <div className="max-w-xl">
                    <div className="w-16 h-16 rounded-2xl bg-gray-900 border border-gray-700 flex items-center justify-center mb-6 group-hover:border-info/50 transition-colors shadow-[0_0_30px_rgba(59,130,246,0.2)] group-hover:shadow-[0_0_50px_rgba(59,130,246,0.4)]">
                    ...
                    <div className="flex items-center text-info font-bold text-sm tracking-widest uppercase bg-info/10 inline-flex px-4 py-2 rounded-lg group-hover:bg-info/20 transition-colors">
                  ...
                  <div className="hidden md:block relative w-64 h-64 border border-gray-800 rounded-2xl bg-gray-950/80 p-4">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-info/20 rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(59,130,246,0.5)]">
            ...
            <Link href="/qa" className="block group md:col-span-2">
              <div className="relative h-full bg-gray-900/40 backdrop-blur-md p-8 md:p-12 rounded-3xl border border-gray-800 hover:border-accent/50 transition-all duration-500 overflow-hidden flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="mt-20 bg-gray-950/80 rounded-[2.5rem] p-12 border border-gray-800 shadow-2xl relative overflow-hidden backdrop-blur-xl">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              {/* Step 2 */}
              <div className="relative group">
                <div className="w-16 h-16 rounded-2xl bg-gray-900 border border-gray-700 flex items-center justify-center mb-6 text-2xl font-black text-gray-500 group-hover:text-warning group-hover:border-warning transition-colors shadow-lg relative z-10">
                  2
                </div>
                <div className="hidden md:block absolute top-8 left-16 w-full h-px bg-gray-800 group-hover:bg-gradient-to-r group-hover:from-warning group-hover:to-transparent transition-all"></div>
              ...
              {/* Step 3 */}
              <div className="relative group">
                <div className="w-16 h-16 rounded-2xl bg-gray-900 border border-gray-700 flex items-center justify-center mb-6 text-2xl font-black text-gray-500 group-hover:text-info group-hover:border-info transition-colors shadow-lg relative z-10">
                  3
                </div>
                <div className="hidden md:block absolute top-8 left-16 w-full h-px bg-gray-800 group-hover:bg-gradient-to-r group-hover:from-info group-hover:to-transparent transition-all"></div>
